                    ...
                    <div class="row">
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          ...
                          <input name="nama" type="text" class="form-control" placeholder="" value="{{ old('nama') ? old('nama') : $admin->nama }}">
                        </div>
                      </div>
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          <label>NIP <i class="text-warning">( *wajib )</i></label>
                          <input name="nip" type="number" class="form-control" placeholder="" value="{{ old('nip') ? old('nip') : $admin->nip }}">
                        </div>
                      </div>
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          <label>NUPTK</label>
                          <input name="nuptk" type="number" class="form-control" value="{{ old('nuptk') ? old('nuptk') : $admin->nuptk }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          ...
                          <input name="status_pegawai" type="text" class="form-control" placeholder="" value="{{ old('status_pegawai') ? old('status_pegawai') : $admin->status_pegawai }}">
                        </div>
                      </div>
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          <label for="jenis_ptk">Jenis ptk <i class="text-warning">( *wajib )</i></label>
                          <input name="jenis_ptk" type="text" class="form-control" placeholder="" value="{{ old('jenis_ptk') ? old('jenis_ptk') : $admin->jenis_ptk }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-4 px-1">
                        <div class="form-group">
                          ...
                          <input name="tugas_tambahan" type="text" class="form-control" value="{{ old('tugas_tambahan') ? old('tugas_tambahan') : $admin->tugas_tambahan }}">
                        </div>
                      </div>
                    </div>
                    <div class="row">
